...
public class Main {
    ...
    /**
     * Il pannello principale che contiene tutti gli altri pannelli.
     */
    private JPanel mainPanel;
    /**
     * Il pannello per la prima riga di componenti.
     */
    private JPanel row1;
    /**
     * Il pannello per la seconda riga di componenti.
     */
    private JPanel row2;
    /**
     * Il pannello per la terza riga di componenti.
     */
    private JPanel row3;
    /**
     * Il pannello che contiene le colonne.
     */
    private JPanel columnsPanel;
    /**
     * Le restrizioni di layout per il GridBagLayout.
     */
    private GridBagConstraints gbc;
    /**
     * L'ultima opzione selezionata nel menu a discesa.
     */
    private String lastSelectedOption = "Tipo e Classe di un IP";
    /**
     * Il pannello per la prima riga di contenuti.
     */
    private JPanel contentRow1;
    /**
     * Il pannello per il modulo di output interno.
     */
    private JPanel innerOutputForm;
    /**
     * Il pannello per la seconda riga di contenuti.
     */
    private JPanel contentRow2;
    /**
     * Il pannello per lo scroll pane.
     */
    private JPanel scrollPanePanel;
    /**
     * L'etichetta per l'output della combo box.
     */
    private JLabel comboBoxLabelOutput; 
    /**
     * Colore chiaro utilizzato per lo sfondo.
     */
    public static final Color LIGHT = new Color(248, 249, 250); 
    /**
     * Colore secondario utilizzato per elementi decorativi.
     */
    public static final Color SECONDARY = new Color(208, 215, 222); 
    /**
     * Colore terziario utilizzato per elementi decorativi.
     */
    public static final Color THIRD = new Color(180, 180, 180); 
    /**
     * Colore grigio scuro utilizzato per elementi di sfondo o testo.
     */
    public static final Color DARK_GRAY = new Color(173, 181, 189); 
    /**
     * Colore primario utilizzato per elementi principali dell'interfaccia utente.
     */
    public static final Color PRIMARY = new Color(0, 123, 255); 
    /**
     * Altezza del modulo di input.
     */
    private static int inputFormHeight = 455;
    /**
     * Altezza del modulo di output.
     */
    private static int outputFormHeight = 140;
    /**
     * Opzione pre-selezionata per l'input.
     */
    private String preSelected = "";
    /**
     * Tipo di input attualmente selezionato.
     */
    private int inputType = 0;
    /**
     * Etichetta per l'output dell'esercizio, con stile arrotondato.
     */
    private RoundedLabel  esercizioLabelOutput;
    /**
     * Mappa che associa i nomi dei componenti alle rispettive istanze di JComponent.
     */
    private HashMap<String, JComponent> componentMap = new HashMap<>();
    /**
     * Pannello aggiuntivo utilizzato per layout o contenuti.
     */
    private JPanel pn1;
    /**
     * Punto di ingresso principale dell'applicazione.
     * <p>
     * Questo metodo è il punto di partenza dell'applicazione Java. 
     * Viene eseguito al lancio dell'applicazione e si occupa di impostare 
     * l'aspetto grafico dell'interfaccia utente (Look and Feel) e di avviare
     * l'interfaccia utente dell'applicazione in modo sicuro, tramite il thread
     * di dispatching degli eventi Swing.
     * </p>
     * <p>
     * In caso di errore durante l'impostazione del Look and Feel, viene stampato
     * lo stack trace dell'eccezione.
     * </p>
     * 
    ...
    /**
     * Crea e visualizza l'interfaccia utente grafica (GUI) dell'applicazione.
     * <p>
     * Questo metodo è responsabile della creazione e della visualizzazione della finestra principale
     * dell'applicazione. Viene eseguito nel thread di dispatching degli eventi Swing per garantire
     * che tutte le operazioni dell'interfaccia utente vengano gestite correttamente.
     * </p>
     */
...
// Ora innerContent1Row3 contiene prima svgCanvas e poi label, entrambi allineati a sinistra e centrati in verticale
 ...
 // Creazione delle tre scritte e aggiunta al JPanel
    ...
    /**
     * Verifica se tutti gli elementi nella lista di controlli sono veri.
     * <p>
     * Questo metodo esamina ogni elemento nella lista {@code checkCalc}. Se trova almeno un elemento
     * che è {@code false}, restituisce {@code false}. Se tutti gli elementi sono veri, restituisce
     * {@code true}.
     * </p>
     * 
     * @param checkCalc Lista di valori booleani da verificare.
     * @return {@code true} se tutti gli elementi nella lista sono veri, {@code false} altrimenti.
     */
    ...
    /**
     * Avvia l'animazione e rende visibili i pannelli e i componenti della finestra modale.
     * <p>
     * Questo metodo attiva le animazioni su vari componenti dell'interfaccia utente e li rende visibili
     * sulla finestra modale.
     * </p>
     * 
     * @param whitePanel Il pannello bianco su cui avviare l'animazione.
     * @param SVGpanel Il pannello SVG su cui avviare l'animazione.
     * @param titleModal L'etichetta del titolo del modale su cui avviare l'animazione.
     * @param textModal L'etichetta del testo del modale su cui avviare l'animazione.
     * @param modalButton Il pulsante del modale su cui avviare l'animazione.
     * @param modalPanel Il pannello del modale da rendere visibile.
     */
    ...
    /**
     * Modifica la visibilità dei campi di input basata sul numero specificato di campi.
     * <p>
     * Questo metodo aggiorna la visibilità dei campi di input e delle etichette in base al numero di
     * campi indicato. Inoltre, aggiorna la dimensione preferita del pannello contenitore.
     * </p>
     * 
     * @param numberOfFields Numero di campi da rendere visibili.
     */
    ...
    /**
     * Listener per la gestione degli eventi di input per i campi di testo di tipo IP.
     * <p>
     * Questo listener limita l'inserimento ai numeri e al punto, e limita la lunghezza del testo
     * a 15 caratteri.
     * </p>
     */
    ...
    /**
     * Listener per la gestione degli eventi di input per i campi di testo di tipo host.
     * <p>
     * Questo listener limita l'inserimento ai numeri e limita la lunghezza del testo a 10 caratteri.
     * </p>
     */
    ...
    /**
     * Listener per la gestione degli eventi di input per i campi di testo di tipo reti.
     * <p>
     * Questo listener limita l'inserimento ai numeri e limita la lunghezza del testo a 3 caratteri.
     * Inoltre, aggiorna la visibilità dei componenti e le dimensioni del pannello in base al valore
     * inserito.
     * </p>
     */
    ...
    /**
     * Crea un {@link MouseListener} per gestire i clic e l'hover su un'etichetta e un pannello SVG.
     * <p>
     * Questo metodo crea un listener che gestisce l'animazione e l'apertura di un link quando l'etichetta
     * o il pannello SVG vengono cliccati. Inoltre, modifica l'aspetto del cursore e dell'animazione quando
     * l'utente passa sopra l'etichetta o il pannello SVG.
     * </p>
     * 
     * @param svgCanvas Il pannello SVG su cui applicare il listener.
     * @param label L'etichetta su cui applicare il listener.
     * @return Un {@link MouseListener} configurato per gestire gli eventi di mouse.
     */
    ...
    /**
     * Aggiorna i componenti di input in base al tipo specificato e all'altezza del modulo di input.
     * <p>
     * Questo metodo gestisce la visibilità dei componenti di input e le loro etichette in base al tipo
     * di input selezionato e ridisegna il modulo di input con l'altezza fornita.
     * </p>
     * 
     * @param type Tipo di input che determina quali componenti devono essere visibili.
     * @param inputFormH Altezza del modulo di input da applicare.
     */
    ...
    /**
     * Ridisegna il modulo di input aggiornando la dimensione preferita delle righe associate.
     *
     * @param inputFormH Altezza desiderata per il modulo di input.
     */
    ...
    /**
     * Ridisegna il modulo di output aggiornando la dimensione preferita delle righe associate.
     *
     * @param outputFormH Altezza desiderata per il modulo di output.
     */
    ...
    /**
     * Aggiorna i vincoli del layout {@link GridBagLayout} basati sulla larghezza corrente del frame.
     * 
     * Questo metodo rimuove tutti i componenti esistenti dal {@link JPanel} di colonne e aggiunge
     * {@code row1} e {@code row2} con i vincoli aggiornati a seconda della larghezza del frame.
     * Se la larghezza del frame è inferiore a 1000 pixel, {@code row1} e {@code row2} verranno
     * posizionati nella stessa colonna e distribuiti uniformemente. Se la larghezza del frame è
     * maggiore o uguale a 1000 pixel, {@code row1} e {@code row2} verranno posizionati in colonne
     * diverse con pesi relativi differenti.
     */
