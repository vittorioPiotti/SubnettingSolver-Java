...
/**
 * Una {@code JLabel} con angoli arrotondati personalizzata.
 * Questa classe estende {@link JLabel} e disegna un'etichetta con angoli arrotondati.
 */
public class RoundedLabel extends JLabel {
    ...
    /**
     * Costruisce un'etichetta con angoli arrotondati.
     *
    ...
    public RoundedLabel(String text, int radius) {
        ...
        setOpaque(false); // Rende trasparente lo sfondo del JLabel
    }

    /**
     * Disegna il componente dell'etichetta. Questo metodo sovrascritto disegna lo sfondo arrotondato e poi il testo dell'etichetta.
     *
    ...
    /**
     * Disegna il bordo dell'etichetta. Questo metodo è lasciato vuoto poiché non è richiesto alcun bordo.
     *
    ...
    /**
     * Restituisce la dimensione preferita dell'etichetta. Il metodo sovrascritto aumenta le dimensioni per tenere conto
     * del raggio degli angoli arrotondati.
     *
     * @return la dimensione preferita dell'etichetta
     */
    @Override
    ...
    /**
     * Restituisce {@code false} poiché l'etichetta è trasparente.
     *
     * @return {@code false}, rendendo il {@code JLabel} stesso trasparente
     */
    @Override
    public boolean isOpaque() {
        return false; // Rende trasparente anche il componente JLabel stesso
    }
}
