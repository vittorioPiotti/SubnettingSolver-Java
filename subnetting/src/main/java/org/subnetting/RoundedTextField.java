...
/**
 * Un {@code JTextField} con bordi arrotondati personalizzati e un bordo colorato.
 * Questa classe estende {@link JTextField} e disegna un campo di testo con uno sfondo arrotondato,
 * un bordo colorato e uno spessore del bordo specificato.
 */
public class RoundedTextField extends JTextField {
    ...
    /**
     * Costruisce un campo di testo con bordi arrotondati, colore del bordo e spessore del bordo.
     *
     * @param radius il raggio degli angoli arrotondati
     * @param borderColor il colore del bordo
     * @param borderWidth lo spessore del bordo
     */
    public RoundedTextField(int radius, Color borderColor, int borderWidth) {
        ...
        setBorder(BorderFactory.createEmptyBorder(4, 8, 4, 8)); // Add some padding inside the text field
    }

    /**
     * Disegna il componente del campo di testo. Questo metodo sovrascritto disegna il background arrotondato
     * e il bordo colorato intorno al campo di testo.
     *
